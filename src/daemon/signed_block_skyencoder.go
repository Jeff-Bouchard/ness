...

				{
					...
					if length != 0 {
						...
						for z5 := range obj.Block.Body.Transactions[z3].Out {
							...
							{
								// obj.Block.Body.Transactions[z3].Out[z5].Delegate.Version
								i, err := d.Uint8()
								if err != nil {
									return 0, err
								}
								obj.Block.Body.Transactions[z3].Out[z5].Delegate.Version = i
							}

							{
								// obj.Block.Body.Transactions[z3].Out[z5].Delegate.Key
								if len(d.Buffer) < len(obj.Block.Body.Transactions[z3].Out[z5].Delegate.Key) {
									return 0, encoder.ErrBufferUnderflow
								}
								copy(obj.Block.Body.Transactions[z3].Out[z5].Delegate.Key[:], d.Buffer[:len(obj.Block.Body.Transactions[z3].Out[z5].Delegate.Key)])
								d.Buffer = d.Buffer[len(obj.Block.Body.Transactions[z3].Out[z5].Delegate.Key):]
							}

							{
								// obj.Block.Body.Transactions[z3].Out[z5].MaxHours
								i, err := d.Uint64()
								if err != nil {
									return 0, err
								}
								obj.Block.Body.Transactions[z3].Out[z5].MaxHours = i
							}

							{
								// obj.Block.Body.Transactions[z3].Out[z5].Expiry
								i, err := d.Uint64()
								if err != nil {
									return 0, err
								}
								obj.Block.Body.Transactions[z3].Out[z5].Expiry = i
							}

							{
								// obj.Block.Body.Transactions[z3].Out[z5].MinInterval
								i, err := d.Uint64()
								if err != nil {
									return 0, err
								}
								obj.Block.Body.Transactions[z3].Out[z5].MinInterval = i
							}

							{
								// obj.Block.Body.Transactions[z3].Out[z5].DelegateLast
								i, err := d.Uint64()
								if err != nil {
									return 0, err
								}
								obj.Block.Body.Transactions[z3].Out[z5].DelegateLast = i
							}
